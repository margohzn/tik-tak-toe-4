    ...
    def creat_widgets(self):
        ...
        for row in range(3):
            for column in range(3):
                button_widget = Button(self.window, text = "", font = ("times", 40), width = 5, height = 2, fg = "black", command = lambda r = row, c = column: self.on_button_click(r,c)) #you use lambda when you need to pass information into the fonction
